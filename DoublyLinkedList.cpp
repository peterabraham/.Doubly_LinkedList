...
void LinkedList::Insert( const int nNumber_i, const int nPosition_i )
{
    ...
    if( nPosition_i == 1 )
    {
        ...
        if( NULL != m_pBaseNode->pNextNode )
        {
            m_pBaseNode->pNextNode->pPrevNode = pNewNode;
        }
    }
    else
    {
...
void LinkedList::DeletePosNode( const int nPosition_i )
{
    ...
    else
    {
        ...
        else
        {
            ...
            pNodeP->pNextNode->pPrevNode = pNodeQ;
            delete pNodeP;
            pNodeP = NULL;
        }
    }
    ...
    while( NULL != pTempNode )
    {
        if( pTempNode->nValue == nNumber_i )
        {
            ...
            else
            {
                ...
                pTempNode->pNextNode->pPrevNode = pPrevNode;
            }
            delete pTempNode;
            pTempNode = NULL;
            return true;
